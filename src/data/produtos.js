const produtos = [
    { id: 1, nome: 'Ração Premium Cães', preco: 120, categoria: 'Alimentos', imagem: '/images/racao-atacao.png' },
    { id: 2, nome: 'Ração Gatos Castrados', preco: 95, categoria: 'Alimentos', imagem: '/images/racao-gato.png' },
    { id: 3, nome: 'Petisco Natural', preco: 18, categoria: 'Alimentos', imagem: '/images/petisco-cao.png' },
